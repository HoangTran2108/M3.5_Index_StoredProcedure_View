...
values ( "P1", "rice", 10.0, 3, "no", 1),
       ("P2", "potato", 20.0, 3, "no", 1),
       ( "P3", "tomato", 15.0, 3, "no", 1),
       ("P4", "corn", 16.9, 3, "no", 1),
	   ("P5", "peanut", 9.1, 3, "no", 1);
       
insert into Products (productCode, productName, productPrice, productDescription, productStatus)
values ("P1", "rice", 10.0, "no", 1);
...
Delimiter //
Create Procedure addrecordsProducts(
                                  in pCode varchar(25),
                                  in pName varchar(25),
                                  in pPrice double,
                                  in pAmount int,
    ...
    BEGIN
    insert into  Products (productCode, productName, productPrice, productAmount, productDescription, productStatus)
    value (pCode, pName, pPrice, pAmount , pDescription , pStatus );
    END//
DELIMITER ;
call addrecordsProducts("p7", "mango", 10.15, 4, "no", 1);
